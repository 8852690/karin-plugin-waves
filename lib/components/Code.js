...
const CONSTANTS = {
    ...
    REFRESH_URL: 'https://api.kurobbs.com/gamer/roleBox/akiBox/refreshData', // 刷新账号资料接口.
    GAME_DATA_URL: 'https://api.kurobbs.com/gamer/widget/game3/refresh', // 体力数据接口.
    BASE_DATA_URL: 'https://api.kurobbs.com/gamer/roleBox/akiBox/baseData', // 探索数据接口.
    ROLE_DATA_URL: 'https://api.kurobbs.com/gamer/roleBox/akiBox/roleData', // 角色列表接口.
    CALABASH_DATA_URL: 'https://api.kurobbs.com/gamer/roleBox/akiBox/calabashData', // 数据坞详情接口.
    CHALLENGE_DATA_URL: 'https://api.kurobbs.com/gamer/roleBox/akiBox/challengeDetails', // 全息战略详情接口.
    EXPLORE_DATA_URL: 'https://api.kurobbs.com/gamer/roleBox/akiBox/exploreIndex', // 探索详情接口.
    ...
    ROLE_DETAIL_URL: 'https://api.kurobbs.com/gamer/roleBox/akiBox/getRoleDetail', // 角色详细信息接口.
    EVENT_LIST_URL: 'https://api.kurobbs.com/forum/companyEvent/findEventList', // 活动列表接口.
    SELF_TOWER_DATA_URL: 'https://api.kurobbs.com/gamer/roleBox/akiBox/towerDataDetail', // 逆境深塔数据接口.
    OTHER_TOWER_DATA_URL: 'https://api.kurobbs.com/gamer/roleBox/akiBox/towerIndex', // 逆境深塔数据接口.
